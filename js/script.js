...
snake1.src = "./asset/snake1.png";
snake2.src = "./asset/snake2.png";
snake3.src = "./asset/snake3.png";
snake4.src = "./asset/snake1.png";
ladder1.src = "./asset/ladder1.png";
ladder2.src = "./asset/ladder1.png";
ladder3.src = "./asset/ladder1.png";

canvas.width = WIDTH;
canvas.height = HEIGHT;
canvasPlayer.width = 300;
canvasPlayer.height = 300;
canvasPlayer.style.background = "#CCF2F4";
...
function Dice(x, y, size, color) {
  ...
  this.drawDice = function (n) {
    _canvasPlayerObj.StrokeRectangle(
      this.x,
      this.y,
      this.size,
      this.size,
